...
exec finance.cangeChance;
exec finance.AddStake  4, 'USD', 1, 3, 0;
select * from finance.ConditionStakesSumView
select * from finance.CustomersBalanceView
select * from finance.CustomersFinanceOperations
select * from finance.Conditions
...
exec finance.ChangeStake 1, 5, 3, 0;
go
exec finance.DeleteStake 3;
go
...
exec finance.AddStake  5, 'USD', 1, 2, 0;---- change
go
exec finance.ChangeStake 1, 5, 3, 0;
go
exec finance.DeleteStake 2;
go

select * from finance.Conditions
go

exec finance.ChackConditions
